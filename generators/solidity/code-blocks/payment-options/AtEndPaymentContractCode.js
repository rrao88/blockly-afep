function getAtEndPaymentCode(offer_id, price, interface_to_implement) {

	function getContractHeader() {
		var code = "contract AtEndPaymentContract is SatislohBaseContract" +
			" {\n\n" +
			"\t//Machine-ID: " + offer_id + "\n\n";
	...
	function getContractConstructor() {
		...
		var code = "\tfunction AtEndPaymentContract() public {\n" +
			"\t\tseller = msg.sender;\n" +
	...
	function getContractConfirmOrderPlaced() {
		...
		var code = "\tfunction confirmOrderPlaced() inState(State.Created) public {\n" +
			"\t\tsuper.orderPlaced();\n" +
			"\t\tstate = State.Ordered;\n" +
			"\t}\n\n";
	...
	function getContractConfirmOrderCompleted() {
		var code = "\tfunction confirmOrderCompleted() inState(State.Received) condition(value == msg.value) payable public {\n" +
