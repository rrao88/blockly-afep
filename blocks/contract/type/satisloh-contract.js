...
Blockly.Blocks['satisloh_base'] = {
	init: function() {
		...
		this.appendDummyInput()
			...
			.appendField(new Blockly.FieldNumber(0, 0, Infinity, 0.1), "price");
		this.appendStatementInput("SHIPPING")
			.setCheck("satisloh_shipping_option")
			.appendField("Shipping Option:");
